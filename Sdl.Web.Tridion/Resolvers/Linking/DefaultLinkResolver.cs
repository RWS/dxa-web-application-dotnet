...
namespace Sdl.Web.Tridion.Linking
{
    ...
    public class DefaultLinkResolver : ILinkResolver
    {
        ...
        private static string GetPublicationUri(Tridion.ContentManager.TcmUri tcmUri, ILocalization localization)
            => (localization == null) ? $"tcm:0-{tcmUri.PublicationId}-1" : localization.GetCmUri();

        private static string ResolveComponentLink(Tridion.ContentManager.TcmUri tcmUri, ILocalization localization)
        {
        ...
        private static string ResolveBinaryLink(Tridion.ContentManager.TcmUri tcmUri, ILocalization localization)
        {
        ...
        private static string ResolvePageLink(Tridion.ContentManager.TcmUri tcmUri, ILocalization localization)
        {
