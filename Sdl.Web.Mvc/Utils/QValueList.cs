...
namespace Sdl.Web.Mvc.Utils
{
    ...
    public sealed class QValueList : List<QValue>
    {
        ...
        #region Fields
        readonly bool _acceptWildcard;
        bool _autoSort;
        #endregion

        #region Constructors
        /// <summary>
        /// Creates a new instance of an QValueList list from the given string of comma delimited values
        /// </summary>
        /// <param name="values">The raw string of qvalues to load</param>
        public QValueList(string values) : this(null == values ? new string[0] : values.Split(Delimiters, StringSplitOptions.RemoveEmptyEntries))
        {            
        }

        /// <summary>
        /// Creates a new instance of an QValueList from  the given string array of qvalues
        /// </summary>
        /// <param name="values">The array of qvalue strings, i.e. name(;q=[0-9\.]+)?</param>
        /// <remarks>
        ...
        public QValueList(IEnumerable<string> values)
        {
            ...
            foreach (string value in values)
            {
                ...
                if (qvalue.Name.Equals("*") || qvalue.Name.Equals("*/*")) // wildcard
                {
            ...
            // this list should be sorted by weight for methods like FindPreferred to work correctly
            DefaultSort();
            _autoSort = true;
        }
        #endregion
        ...
        public QValue this[params string[] candidates]
        {
            get
            {
                return FindPreferred(candidates);
            }
        }
        #endregion
        ...
        #region Add
        /// <summary>
        /// Adds an item to the list, then applies sorting if AutoSort is enabled.
        /// </summary>
        ...
        #region AddRange
        /// <summary>
        /// Adds a range of items to the list, then applies sorting if AutoSort is enabled.
        /// </summary>
        ...
        #region isCandidate
        /// <summary>
        /// Determines if the given item contained within the applied array (case-insensitive)
        /// </summary>
