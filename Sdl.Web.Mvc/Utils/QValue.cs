...
namespace Sdl.Web.Mvc.Utils
{
    ...
    public struct QValue : IComparable<QValue>
    {
        ...
        public QValue(string value) : this(value, 0)
        {
        }
        ...
        /// </summary>
        /// <param name="value">The value to be parsed e.g. gzip=0.3</param>
        /// <param name="ordinal">The ordinal/index where the item was found in the original list.</param>
        ...
        #region Methods
        /// <summary>
        /// Parses the given string for name and weigth (qvalue)
        /// </summary>
        ...
        private static void ParseInternal(ref QValue target, string value)
        {
            ...
            if (parts.Length == 3)
            {
                float.TryParse(parts[2], NumberStyles.Any, CultureInfo.InvariantCulture, out target._weight);
            }
        }
        #endregion
        ...
        /// <summary>
        /// Compares this instance to another QValue by comparing first weights, then ordinals.
        /// </summary>
