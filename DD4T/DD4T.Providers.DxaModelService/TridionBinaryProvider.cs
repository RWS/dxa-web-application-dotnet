...
namespace DD4T.Providers.DxaModelService
{
    ...
    public class TridionBinaryProvider : BaseProvider, IBinaryProvider
    {
        ...
        private BinaryMetaFactory _binaryMetaFactory;
        private BinaryMetaFactory BinaryMetaFactory => _binaryMetaFactory ?? (_binaryMetaFactory = new BinaryMetaFactory());
        private readonly Dictionary<int, ComponentMetaFactory> _tridionComponentMetaFactories = new Dictionary<int, ComponentMetaFactory>();
