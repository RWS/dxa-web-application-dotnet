...
namespace DD4T.Providers.DxaModelService
{
    public class TridionTaxonomyProvider : BaseProvider, ITaxonomyProvider, IDisposable
    {
        ...
        public TaxonomyFactory TaxonomyFactory => _taxonomyFactory ?? (_taxonomyFactory = new TaxonomyFactory());
        ...
        #region Private
        private static Keyword Recursive(List<Keyword> keywords, string valueToLookFor)
        {
        ...
        protected virtual void Dispose(bool isDisposed)
        {
            ...
            if (_taxonomyFactory == null) return;
